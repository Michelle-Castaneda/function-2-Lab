...
// ***** Do not edit the code below *****      'DECLARATION'
...
// CODE HERE
const param = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`);
...
passing in the value firstName and lastName of your choice, and a callback function that 
takes a parameter of fullName. 
The callback function will print 'Hello, my full name is [fullName]'. 
*/

// CODE 'GREETING FUNCTION' HERE

const greeting = (firstName, lastName,cb) => { //Write a function called 'greeting' that takes 3 parameters: firstName, lastName, and a callback function. 
   cb(firstName + " " + lastName);  //invoke the callback, passing in a concatenation of firstName and lastName. 
}
// INVOKE 'GREETING FUNCTION' HERE

greeting('Michelle', 'Castaneda', (fullName) => //outside of the greeting function, invoke the greeting function,
console.log(`Hello, my full name is ${fullName}`)); //The callback function will print 'Hello, my full name is [fullName]'. 
...
Inside the function, loop over the 'prices' array. 
For every iteration, calculate a new total cost (original price plus 20% tax), 
...
const pricesPlusTax = function(prices,cb) { //write a function called 'pricesPlusTax' that takes 2 params: an array ('prices' array) and a callback function.
    for(let i = 0; i < prices.length; i++) { //Inside the function, loop over the 'prices' array.
    totalCost.push(prices[i]* 1.20);
    }
cb(totalCost);
}
...
/* 
Invoke the 'pricesPlusTax' function, passing in the 'prices' array and a callback function 
(passing in 'totalCost' as a param) that will print "The new array plus tax = [totalCost]"
*/
...
function multiplyingFactory(number) {
    return function(secondNumber){
        ...
        console.log(`Cannot multiply: ${number} is smaller than 5`)
    }
    }
}

/* 
Let's invoke the 'multiplyingFactory' function that will return another function, and save it into a variable called 'timesFour.' 
